...
BattleScript_EffectTwerking::
	attackcanceler
	attackstring
	ppreduce
BattleScript_EffectTwerkingFromStatUp::
	jumpifstat BS_ATTACKER, CMP_LESS_THAN, STAT_SPATK, MAX_STAT_STAGE, BattleScript_TwerkingDoMoveAnim
	jumpifstat BS_ATTACKER, CMP_EQUAL, STAT_SPEED, MAX_STAT_STAGE, BattleScript_CantRaiseMultipleStats
BattleScript_TwerkingDoMoveAnim::
	attackanimation
	waitanimation
	setbyte sSTAT_ANIM_PLAYED, FALSE
	playstatchangeanimation BS_ATTACKER, BIT_ATK | BIT_SPEED, 0
	setstatchanger STAT_SPATK, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_TwerkingTrySpeed
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_TwerkingTrySpeed
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_TwerkingTrySpeed::
	setstatchanger STAT_SPEED, 1, FALSE
	statbuffchange MOVE_EFFECT_AFFECTS_USER | STAT_CHANGE_ALLOW_PTR, BattleScript_TwerkingEnd
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_TwerkingEnd
	printfromtable gStatUpStringIds
	waitmessage B_WAIT_TIME_LONG
BattleScript_TwerkingEnd::
	goto BattleScript_MoveEnd
...
BattleScript_HandleFaintedMon::
	...
	jumpifbattletype BATTLE_TYPE_TRAINER | BATTLE_TYPE_DOUBLE | BATTLE_TYPE_TOTEM_BATTLE, BattleScript_FaintedMonTryChoose
...
BattleScript_FaintedMonTryChoose:
	...
	jumpifbattletype BATTLE_TYPE_TOTEM_BATTLE, BattleScript_FaintedMonSendOutNew
...
BattleScript_PrintCantRunFromTotemBattle::
	printstring STRINGID_NORUNNINGFROMTOTEMBATTLE
	end2
...
BattleScript_CokePowderRet::
	statbuffchange STAT_CHANGE_ALLOW_PTR, BattleScript_CokePowderRet_TryConfuse
	setgraphicalstatchangevalues
	playanimation BS_SCRIPTING, B_ANIM_HELD_ITEM_EFFECT, sB_ANIM_ARG1
	setbyte cMULTISTRING_CHOOSER, B_MSG_STAT_ROSE_ITEM
	call BattleScript_StatUp
BattleScript_CokePowderRet_TryConfuse:
	jumpifability BS_SCRIPTING, ABILITY_OWN_TEMPO, BattleScript_CokePowderRet_OwnTempoPrevents
	jumpifsafeguard BattleScript_CokePowderRet_SafeguardProtected
	seteffectprimary MOVE_EFFECT_CONFUSION
	goto BattleScript_CokePowderRet_End
BattleScript_CokePowderRet_SafeguardProtected::
	pause B_WAIT_TIME_SHORT
	printstring STRINGID_PKMNUSEDSAFEGUARD
	waitmessage B_WAIT_TIME_LONG
	goto BattleScript_CokePowderRet_End
BattleScript_CokePowderRet_OwnTempoPrevents:
	pause B_WAIT_TIME_SHORT
	call BattleScript_AbilityPopUp
	printstring STRINGID_PKMNPREVENTSCONFUSIONWITH
	waitmessage B_WAIT_TIME_LONG
BattleScript_CokePowderRet_End:
	restoretarget
	removeitem BS_SCRIPTING
	end3
