...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 113, 54, 0, 0, 32, PALETTES_BG, SPECIES_SLAKOTH);
...
{
    return CreateMonPicSprite_Affine(SPECIES_SLAKOTH, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
