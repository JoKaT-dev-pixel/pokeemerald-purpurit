...
static void HeatStartMenu_LoadBgGfx(void)
{
  ...
  if (IsLShortcutEnabledInGame() == FALSE)
  {
    if (GetSafariZoneFlag())
    {
      ...
      {
      case 2:
        LZDecompressWram(sStartMenuTilemapSafari2, buf);
        break;
      case 3:
        LZDecompressWram(sStartMenuTilemapSafari3, buf);
        break;
      case 4:
        LZDecompressWram(sStartMenuTilemapSafari4, buf);
        break;
      case 5:
        LZDecompressWram(sStartMenuTilemapSafari5, buf);
        break;
      case 6:
        LZDecompressWram(sStartMenuTilemapSafari6, buf);
        break;
      default:
        LZDecompressWram(sStartMenuTilemapSafari7, buf);
        break;
      }
    }
    else
    {
      ...
      {
      case 2:
        LZDecompressWram(sStartMenuTilemap2, buf);
        break;
      case 3:
        LZDecompressWram(sStartMenuTilemap3, buf);
        break;
      case 4:
        LZDecompressWram(sStartMenuTilemap4, buf);
        break;
      case 5:
        LZDecompressWram(sStartMenuTilemap5, buf);
        break;
      case 6:
        LZDecompressWram(sStartMenuTilemap6, buf);
        break;
      default:
        LZDecompressWram(sStartMenuTilemap7, buf);
        break;
      }
    }
  }
  else
  {
    if (GetSafariZoneFlag())
    {
      ...
      {
      case 2:
        LZDecompressWram(sStartMenuTilemapLSafari2, buf);
        break;
      case 3:
        LZDecompressWram(sStartMenuTilemapLSafari3, buf);
        break;
      case 4:
        LZDecompressWram(sStartMenuTilemapLSafari4, buf);
        break;
      case 5:
        LZDecompressWram(sStartMenuTilemapLSafari5, buf);
        break;
      case 6:
        LZDecompressWram(sStartMenuTilemapLSafari6, buf);
        break;
      default:
        LZDecompressWram(sStartMenuTilemapLSafari7, buf);
        break;
      }
    }
    else
    {
      ...
      {
      case 2:
        LZDecompressWram(sStartMenuTilemapL2, buf);
        break;
      case 3:
        LZDecompressWram(sStartMenuTilemapL3, buf);
        break;
      case 4:
        LZDecompressWram(sStartMenuTilemapL4, buf);
        break;
      case 5:
        LZDecompressWram(sStartMenuTilemapL5, buf);
        break;
      case 6:
        LZDecompressWram(sStartMenuTilemapL6, buf);
        break;
      default:
        LZDecompressWram(sStartMenuTilemapL7, buf);
        break;
      }
    }
  }
...
static const u8 gText_Poketch[] = _("PokéPad");
static const u8 gText_Pokedex[] = _("Pokédex");
static const u8 gText_Party[]   = _("Équipe");
static const u8 gText_Bag[]     = _("Sac");
static const u8 gText_Trainer[] = _("Trainer");
static const u8 gText_Save[]    = _("Sauver");
static const u8 gText_Options[] = _("Options");
static const u8 gText_Flag[]    = _("Partir");
...
static void HeatStartMenu_UpdateMenuName(void)
{
  ...
  case HSMO_BAG:
    ...
    break;
  case HSMO_TRAINER_CARD:
    menuNameString = playerNameDisplay;
    break;
  case HSMO_SAVE:
