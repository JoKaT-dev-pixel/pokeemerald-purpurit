...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_NUN, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {TRAINER_CLASS_GRAFFITIST, TRAINER_ENCOUNTER_MUSIC_COOL},
    {TRAINER_CLASS_STRATEGIST, TRAINER_ENCOUNTER_MUSIC_COOL},
    {TRAINER_CLASS_LITTLE_BOY, TRAINER_ENCOUNTER_MUSIC_GIRL},
    {TRAINER_CLASS_LITTLE_GIRL, TRAINER_ENCOUNTER_MUSIC_GIRL},
};
