const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_NUN] = TRAINER_PIC_MAGMA_GRUNT_F,
    [FACILITY_CLASS_GRAFFITIST] = TRAINER_PIC_EXPERT_M,
    [FACILITY_CLASS_STRATEGIST] = TRAINER_PIC_COOLTRAINER_M,
    [FACILITY_CLASS_GYM_LEADER_F] = TRAINER_PIC_LEADER_FLANNERY,
    [FACILITY_CLASS_LITTLE_BOY] = TRAINER_PIC_TUBER_M,
    [FACILITY_CLASS_LITTLE_GIRL] = TRAINER_PIC_TUBER_F,
    [FACILITY_CLASS_TRAINER_CARD_M] = TRAINER_PIC_TRAINER_CARD_M,
    [FACILITY_CLASS_TRAINER_CARD_F] = TRAINER_PIC_TRAINER_CARD_F,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_NUN] = TRAINER_CLASS_NUN,
    [FACILITY_CLASS_GRAFFITIST] = TRAINER_CLASS_GRAFFITIST,
    [FACILITY_CLASS_STRATEGIST] = TRAINER_CLASS_STRATEGIST,
    [FACILITY_CLASS_GYM_LEADER_F] = TRAINER_CLASS_GYM_LEADER_F,
    [FACILITY_CLASS_LITTLE_BOY] = TRAINER_CLASS_LITTLE_BOY,
    [FACILITY_CLASS_LITTLE_GIRL] = TRAINER_CLASS_LITTLE_GIRL,
    [FACILITY_CLASS_TRAINER_CARD_M] = TRAINER_PIC_TRAINER_CARD_M,
    [FACILITY_CLASS_TRAINER_CARD_F] = TRAINER_PIC_TRAINER_CARD_F,
};
