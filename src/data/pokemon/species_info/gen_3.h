...
#define SCEPTILE_MISC_INFO                                  \
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_SHED_SKIN, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Serpuff"),
        .cryId = CRY_TORCHIC,
...
#define BLAZIKEN_MISC_INFO                                  \
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_LIQUID_OOZE, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lubryon"),
        .cryId = CRY_MUDKIP,
...
#define SWAMPERT_MISC_INFO                                      \
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_PRANKSTER, ABILITY_RUN_AWAY, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Loustiris"),
        .cryId = CRY_POOCHYENA,
...
#define LINOONE_MISC_INFO                                                       \
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_IMMUNITY, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Larvert"),
        .cryId = CRY_WURMPLE,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_BAD_LUCK, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Cornaigri"),
        .cryId = CRY_TAILLOW,
        .natDexNum = NATIONAL_DEX_TAILLOW,
        .categoryName = _("Corneille"),
        .height = 3,
        .weight = 23,
        .description = COMPOUND_STRING(
        ...
        LEARNSETS(Taillow),
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_SWELLOW}),
    },
...
#define GALLADE_MISC_INFO                                   \
    ...
    [SPECIES_SHROOMISH] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_GRASS_PELT, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Farfarouch"),
        .cryId = CRY_SHROOMISH,
        .natDexNum = NATIONAL_DEX_SHROOMISH,
        .categoryName = _("Lutin"),
        .height = 4,
        .weight = 45,
        .description = COMPOUND_STRING(
        ...
        LEARNSETS(Shroomish),
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_BRELOOM}),
    },
