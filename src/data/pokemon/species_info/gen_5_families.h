...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .abilities = { ABILITY_CANNABINOID, ABILITY_LEAF_GUARD, ABILITY_FLARE_BOOST },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Herbeuh"),
        .cryId = CRY_PETILIL,
        .natDexNum = NATIONAL_DEX_PETILIL,
        .categoryName = _("Cannabis"),
        .height = 3,
        .weight = 22,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_DOWNLOAD, ABILITY_SURGE_SURFER },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Élekclik"),
        .cryId = CRY_TYNAMO,
        .natDexNum = NATIONAL_DEX_TYNAMO,
        .categoryName = _("Curseur"),
        .height = 2,
        .weight = 3,
        .description = COMPOUND_STRING(
