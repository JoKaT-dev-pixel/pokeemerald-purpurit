...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_STEEL : TYPE_PSYCHIC)
    ...
    [SPECIES_SLAKOTH] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Caffuccino"),
        .cryId = CRY_SLAKOTH,
        .natDexNum = NATIONAL_DEX_SLAKOTH,
        .categoryName = _("Tasse à Café"),
        .height = 8,
        .weight = 240,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_STATIC, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Hérissohm"),
        .cryId = CRY_MAKUHITA,
        .natDexNum = NATIONAL_DEX_MAKUHITA,
        .categoryName = _("Sneackers"),
        .height = 10,
        .weight = 864,
        .description = COMPOUND_STRING(
