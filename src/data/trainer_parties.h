...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .ev = TRAINER_PARTY_EVS(4, 4, 4, 4, 4, 16),
    .lvl = 11,
    .species = SPECIES_GEODUDE,
    .ability = ABILITY_STURDY,
    .nature = NATURE_IMPISH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_MUD_SLAP, MOVE_T_POSE, MOVE_SAND_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .ev = TRAINER_PARTY_EVS(4, 4, 4, 4, 4, 4),
    .lvl = 12,
    .species = SPECIES_LILEEP,
    .ability = ABILITY_SOLID_ROCK,
    .nature = NATURE_ADAMANT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_SCREECH, MOVE_WHIRLPOOL, MOVE_DRAGON_TAIL}
    },
    {
    ...
    .nature = NATURE_JOLLY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_ROCK_POLISH, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .moves = {MOVE_ENDEAVOR, MOVE_POWER_UP_PUNCH, MOVE_BONE_CLUB, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .ev = TRAINER_PARTY_EVS(40, 40, 40, 40, 40, 40),
    ...
    .ability = ABILITY_DETERMINATION,
    .nature = NATURE_ADAMANT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MACH_PUNCH, MOVE_RETALIATE, MOVE_THUNDER_PUNCH, MOVE_POUNCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(8, 40, 0, 12, 0, 8),
    .lvl = 21,
    .species = SPECIES_MACHOKE,
    .ability = ABILITY_GUTS,
    .nature = NATURE_CAREFUL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BULK_UP, MOVE_MEGA_PUNCH, MOVE_VITAL_THROW, MOVE_BONE_CLUB}
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .ev = TRAINER_PARTY_EVS(24, 24, 24, 24, 24, 24),
    .lvl = 25,
    .species = SPECIES_TYNAMO,
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_MODEST,
    .heldItem = ITEM_TERRAIN_EXTENDER,
    .moves = {MOVE_VOLT_SWITCH, MOVE_ELECTRIC_TERRAIN, MOVE_FLAME_CHARGE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .ev = TRAINER_PARTY_EVS(24, 24, 64, 24, 72, 24),
    .lvl = 26,
    .species = SPECIES_SUNFLORA,
    .ability = ABILITY_ILLUMINATE,
    .nature = NATURE_BOLD,
    .heldItem = ITEM_ELECTRIC_SEED,
    .moves = {MOVE_FLASHBANG, MOVE_GIGA_DRAIN, MOVE_NATURE_POWER, MOVE_MIRROR_SHOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .ev = TRAINER_PARTY_EVS(48, 64, 0, 64, 0, 0),
    .lvl = 27,
    .species = SPECIES_SABLEYE,
    .ability = ABILITY_MAGNET_PULL,
    .nature = NATURE_LAX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_GEAR_GRIND, MOVE_RAPID_SPIN, MOVE_MAGNET_RISE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .ev = TRAINER_PARTY_EVS(0, 88, 32, 8, 0, 32),
    .lvl = 29,
    .species = SPECIES_MANECTRIC,
    .ability = ABILITY_STUN_GUN,
    .nature = NATURE_ADAMANT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SPARK, MOVE_RAZOR_SHELL, MOVE_METAL_CLAW, MOVE_HONE_CLAWS}
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .moves = {MOVE_TORCH_SONG, MOVE_AERIAL_ACE, MOVE_CLOSE_COMBAT, MOVE_ROOST}
    },
    {
    ...
    .lvl = 42,
    .species = SPECIES_GOLBAT,
    .ability = ABILITY_RECORDING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AIR_SLASH, MOVE_OVERDRIVE, MOVE_U_TURN, MOVE_PERISH_SONG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 44,
    ...
    .moves = {MOVE_CHATTER, MOVE_HYPER_VOICE, MOVE_HEAT_WAVE, MOVE_PSYCHIC}
    }
};
...
static const struct TrainerMon sParty_MayRoute103Mudkip[] = {
    ...
    .lvl = 5,
    .species = SPECIES_TREECKO,
    .moves = {MOVE_SCRATCH, MOVE_TAIL_WHIP, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Cristian[] = {
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_FOCUS_PUNCH, MOVE_SUBSTITUTE, MOVE_DOUBLE_TEAM, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_MayRustboroMudkip[] = {
    ...
    .nature = NATURE_BOLD,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_LEAFAGE, MOVE_PHOTOPHOBIE, MOVE_CONFUSION, MOVE_DETECT}
    }
};
...
static const struct TrainerMon sParty_MayRustboroTreecko[] = {
    ...
    .nature = NATURE_IMPISH,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EMBER, MOVE_TEAR_GAS, MOVE_POISON_TAIL, MOVE_THIEF}
    }
};
...
static const struct TrainerMon sParty_MayRustboroTorchic[] = {
    ...
    .nature = NATURE_BOLD,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_BUBBLE, MOVE_DROPLETS, MOVE_DRAINING_KISS, MOVE_LICK}
    }
};
...
static const struct TrainerMon sParty_NunCathedral[] = {
    {
    .lvl = 10,
    .species = SPECIES_SHROOMISH,
    },
