...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_DIRE_CLAW] = _("Griffes Funestes"),
    ...
    [MOVE_POUNCE] = _("Bond"),
    [MOVE_TRAILBLAZE] = _("Désherbaffe"),
    [MOVE_CHILLING_WATER] = _("Douche Froide"),
    ...
    [MOVE_HYDRO_STEAM] = _("Hydrovapeur"),
    ...
    [MOVE_ALLURING_VOICE] = _("Voix Envoûtante"),
    [MOVE_TEMPER_FLARE] = _("Indignition"),
    [MOVE_SUPERCELL_SLAM] = _("Volt Assaut"),
    [MOVE_PSYCHIC_NOISE] = _("Psychic Noise"),
    [MOVE_UPPER_HAND] = _("Upper Hand"),
    [MOVE_MALIGNANT_CHAIN] = _("Malignant Chain"),
    [MOVE_NIBBLE] = _("Grignotage"),
    [MOVE_BEATDOWN] = _("Tabassage"),
    [MOVE_KAMEHAMEHA] = _("Kamé Hamé Ha"),
    [MOVE_DIVEBOMB] = _("Bombardier"),
    [MOVE_TEAR_GAS] = _("Gaz Poivre"),
    [MOVE_BLOOD_DRAW] = _("Prise de Sang"),
    [MOVE_MUSTARD_GAS] = _("Gaz Moutarde"),
    [MOVE_STAMPEDE] = _("Rodéo"),
    [MOVE_T_POSE] = _("Pétrification"),
    [MOVE_BLITZKRIEG] = _("Blitzkrieg"),
    [MOVE_EXCALIBUR] = _("Excalibur"),
    [MOVE_FIRE_BREATH] = _("Souffle Feu"),
    [MOVE_BOIL_OFF] = _("Bomb'Essence"),
    [MOVE_KAMIKAZE] = _("Kamikaze"),
    [MOVE_BUBBLE_JET] = _("Jet-Bulles"),
    [MOVE_PSYCHO_HERB] = _("Psycho-Herbe"),
    [MOVE_PEPPER_POWDER] = _("Poudre Piquante"),
    [MOVE_MAGIC_BEAN] = _("Haricot Magik"),
    [MOVE_JUMPSTART] = _("Démarrage"),
    [MOVE_FLASHBANG] = _("Flashbang"),
    [MOVE_ELECTROSHOCK] = _("Électrochoc"),
    [MOVE_GLITCH_FORCE] = _("Malware"),
    [MOVE_POWER_SURGE] = _("Survoltage"),
    [MOVE_PHOTOPHOBIE] = _("Migraine"),
    [MOVE_PSYCHOTISM] = _("Psychotisme"),
    [MOVE_FROSTBITE] = _("Gelure"),
    [MOVE_COMING_OUT] = _("Coming Out"),
    [MOVE_DROPLETS] = _("Gouttelettes"),
    [MOVE_RAINBOW_BEAM] = _("Onde Coloré"),
    [MOVE_CUPID_ARROW] = _("Cupi-Flèche"),
    [MOVE_PEEKABOO] = _("Cache-Cache"),
    [MOVE_TWERKING] = _("Twerk"),
    [MOVE_FAIR_PLAY] = _("Fair-Play"),
    // Max Moves
...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_POUNCE] = _("Bond"),
    [MOVE_TRAILBLAZE] = _("Désherbaffe"),
    [MOVE_CHILLING_WATER] = _("DoucheFroide"),
    [MOVE_HYPER_DRILL] = _("Hyper Drill"),
    [MOVE_TWIN_BEAM] = _("Twin Beam"),
    [MOVE_RAGE_FIST] = _("Rage Fist"),
    [MOVE_ARMOR_CANNON] = _("Armor Cannon"),
    ...
    [MOVE_KAMEHAMEHA] = _("Kamé Hamé Ha"),
    [MOVE_DIVEBOMB] = _("Bombardier"),
    [MOVE_TEAR_GAS] = _("Gaz Lacryma"),
    [MOVE_BLOOD_DRAW] = _("Prise d'Sang"),
    [MOVE_MUSTARD_GAS] = _("Gaz Moutarde"),
    [MOVE_STAMPEDE] = _("Rodéo"),
    [MOVE_T_POSE] = _("Pétrifier"),
    [MOVE_BLITZKRIEG] = _("Blitzkrieg"),
    [MOVE_EXCALIBUR] = _("Excalibur"),
    [MOVE_FIRE_BREATH] = _("Souffle Feu"),
    [MOVE_BOIL_OFF] = _("Bomb'Essence"),
    ...
    [MOVE_BUBBLE_JET] = _("Jet-Bulles"),
    [MOVE_PSYCHO_HERB] = _("Psycho-Herbe"),
    [MOVE_PEPPER_POWDER] = _("PoudrePoivre"),
    [MOVE_MAGIC_BEAN] = _("Haricot Magik"),
    [MOVE_JUMPSTART] = _("Démarrage"),
    [MOVE_FLASHBANG] = _("Flashbang"),
    [MOVE_ELECTROSHOCK] = _("Électrochoc"),
