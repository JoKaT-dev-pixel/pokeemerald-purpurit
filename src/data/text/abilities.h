...
static const u8 sOwnTempoDescription[] = _("Immunise le Pokémon contre la\nconfusion et l'intimidation.");
...
static const u8 sSereneGraceDescription[] = _("Augmente les chances de\ngénérer des effets cumulés.");
...
static const u8 sKeenEyeDescription[] = _("Empêche le Pokémon de perdre\nen précision.");
...
static const u8 sShedSkinDescription[] = _("Soigne parfois ses altérations\nde statut en muant.");
...
static const u8 sLiquidOozeDescription[] = _("Blesse l'ennemi qui draine\nl'énergie du Pokémon.");
static const u8 sOvergrowDescription[] = _("Booste les capacités de type\nPlante en cas de besoin.");
static const u8 sBlazeDescription[] = _("Booste les capacités de type\nFeu en cas de besoin.");
static const u8 sTorrentDescription[] = _("Booste les capacités de type\nEau en cas de besoin.");
...
static const u8 sSniperDescription[] = _("Booste les capacités qui sont\ndes coups critiques.");
...
static const u8 sSuperLuckDescription[] = _("Augmente la fréquence des\ncoups critiques.");
...
static const u8 sTintedLensDescription[] = _("Améliore les capacités “pas\ntrès efficaces”.");
...
static const u8 sScrappyDescription[] = _("Les capacités Normal et Combat\ntouchent les Pokémon Spectre.");
...
static const u8 sDisguiseDescription[] = _("La boîte qui recouvre le Pokémon\nprotège d'une attaque.");
...
static const u8 sBallFetchDescription[] = _("Ramasse la Poké Ball lors du\npremier lancer raté.");
...
static const u8 sPheromoneDescription[] = _("Influence l'ennemi et baisse\nson Attaque Spéciale.");
static const u8 sDataDrawDescription[] = _("Baisse l'Atq. Spé. ennemie.");
static const u8 sZeroVoltDescription[] = _("Permet aux capacités de type\nÉlectrik de toucher le type Sol.");
static const u8 sMirageDescription[] = _("Augmente l'Esquive du Pokémon\ns'il y a du soleil.");
static const u8 sColdShoulderDescription[] = _("Peut geler l'attaquant s'il\ny a contact.");
static const u8 sMesmerizeDescription[] = _("Peut endormir l'attaquant s'il\ny a contact.");
static const u8 sSoulSapDescription[] = _("Récupère des PV si touché par\nune capacité Spectre.");
static const u8 sThirdEyeDescription[] = _("Baisse l'Atq. Spé. ennemie.");
static const u8 sWaterproofDescription[] = _("Diminue de moitié la puissance\ndes capacités de type Eau.");
static const u8 sRegalDescription[] = _("Toutes les capacités offensives\ndu Pokémon sont prioritaires.");
static const u8 sPerfectionistDescription[] = _("Baisse l'Atq. Spé. ennemie.");
static const u8 sSolarPanelsDescription[] = _("Récupère progressivement des\nPV lorsqu'il y a du soleil.");
static const u8 sBadLuckDescription[] = _("Réduit les chances des effets\nadditionnels adverses.");
static const u8 sPanicAttackDescription[] = _("Monte la Vitesse au max après\nun coup critique.");
static const u8 sTyrantDescription[] = _("Augmente l'Atq et l'Atq Spé.\naprès un coup super efficace.");
static const u8 sEccentricDescription[] = _("Améliore l'Attaque Spéciale,\nmais diminue la Précision.");
static const u8 sRobustDescription[] = _("Diminue les dégâts qu'il subit\nquand les PV tombent de moitié.");
static const u8 sAmplifierDescription[] = _("Booste les capacités et réduit\nles dégâts basés sur le son.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_DISGUISE] = _("Cache-Boîte"),
    ...
    [ABILITY_PHEROMONE] = _("Phéromone"),
    [ABILITY_DATA_DRAW] = _("Algorithme"),
    [ABILITY_ZERO_VOLT] = _("Zéro Volt"),
    [ABILITY_MIRAGE] = _("Mirage"),
    [ABILITY_COLD_SHOULDER] = _("Épaule Froide"),
    [ABILITY_MESMERIZE] = _("Hypnotique"),
    [ABILITY_SOUL_SAP] = _("Absorbe-Âme"),
    [ABILITY_THIRD_EYE] = _("Troisième Œil"),
    [ABILITY_WATERPROOF] = _("Imperméabilité"),
    [ABILITY_REGAL] = _("Régalien"),
    [ABILITY_PERFECTIONIST] = _("Perfectionniste"),
    [ABILITY_SOLAR_PANELS] = _("Photovoltaïque"),
    [ABILITY_BAD_LUCK] = _("Malchance"),
    [ABILITY_PANIC_ATTACK] = _("Crise d'Angoisse"),
    [ABILITY_TYRANT] = _("Tyran"),
    [ABILITY_ECCENTRIC] = _("Excentrique"),
    [ABILITY_ROBUST] = _("Robustesse"),
    [ABILITY_AMPLIFIER] = _("Amplificateur"),
};
#else   // 12 characters
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ZERO_VOLT] = _("Zéro Volt"),
    [ABILITY_MIRAGE] = _("Mirage"),
    [ABILITY_COLD_SHOULDER] = _("ÉpauleFroide"),
    [ABILITY_MESMERIZE] = _("Hypnotique"),
    [ABILITY_SOUL_SAP] = _("Absorbe-Âme"),
    [ABILITY_THIRD_EYE] = _("Trois. Œil"),
    [ABILITY_WATERPROOF] = _("Étanche"),
    [ABILITY_REGAL] = _("Régalien"),
    [ABILITY_PERFECTIONIST] = _("Perfection"),
    [ABILITY_SOLAR_PANELS] = _("Photovoltaïk"),
    [ABILITY_BAD_LUCK] = _("Malchance"),
    [ABILITY_PANIC_ATTACK] = _("Crise Panic"),
    [ABILITY_TYRANT] = _("Tyran"),
    [ABILITY_ECCENTRIC] = _("Excentrique"),
    [ABILITY_ROBUST] = _("Robustesse"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_PHEROMONE] = sPheromoneDescription,
    [ABILITY_DATA_DRAW] = sDataDrawDescription,
    [ABILITY_ZERO_VOLT] = sZeroVoltDescription,
    [ABILITY_MIRAGE] = sMirageDescription,
    [ABILITY_COLD_SHOULDER] = sColdShoulderDescription,
    [ABILITY_MESMERIZE] = sMesmerizeDescription,
    [ABILITY_SOUL_SAP] = sSoulSapDescription,
    [ABILITY_THIRD_EYE] = sThirdEyeDescription,
    [ABILITY_WATERPROOF] = sWaterproofDescription,
    [ABILITY_REGAL] = sRegalDescription,
    ...
    [ABILITY_TYRANT] = sTyrantDescription,
    [ABILITY_ECCENTRIC] = sEccentricDescription,
