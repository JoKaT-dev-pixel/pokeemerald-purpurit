...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ZERO_VOLT] = _("Zéro Volt"),
    [ABILITY_MIRAGE] = _("Mirage"),
    [ABILITY_CRYOGENIC] = _("ÉpauleFroide"),
    [ABILITY_MESMERIZE] = _("Hypnotique"),
    [ABILITY_SOUL_SAP] = _("Absorbe-Âme"),
