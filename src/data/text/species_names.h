const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_RATTATA] = _("Rapouille"),
    [SPECIES_RATICATE] = _("Pestomys"),
    [SPECIES_SPEAROW] = _("Spearow"),
    [SPECIES_FEAROW] = _("Fearow"),
    [SPECIES_EKANS] = _("Ekans"),
    [SPECIES_ARBOK] = _("Arbok"),
    [SPECIES_PIKACHU] = _("Bouldeboue"),
    [SPECIES_RAICHU] = _("Raichu"),
    [SPECIES_SANDSHREW] = _("Tatoom"),
    [SPECIES_SANDSLASH] = _("Pangozer"),
    ...
    [SPECIES_MEOWTH] = _("Chileo"),
    [SPECIES_PERSIAN] = _("Manticron"),
    ...
    [SPECIES_ABRA] = _("Phantasme"),
    [SPECIES_KADABRA] = _("Kadabra"),
    [SPECIES_ALAKAZAM] = _("Alakazam"),
    [SPECIES_MACHOP] = _("Tendos"),
    [SPECIES_MACHOKE] = _("Muscleps"),
    [SPECIES_MACHAMP] = _("Carcaflex"),
    ...
    [SPECIES_GEODUDE] = _("Frargile"),
    [SPECIES_GRAVELER] = _("Herstèle"),
    [SPECIES_GOLEM] = _("Sigmoai"),
    ...
    [SPECIES_DITTO] = _("Blobignon"),
    [SPECIES_EEVEE] = _("Errovoli"),
    [SPECIES_VAPOREON] = _("Vaporweon"),
    ...
    [SPECIES_SPINARAK] = _("Pistourmi"),
    [SPECIES_ARIADOS] = _("Ariados"),
    [SPECIES_CROBAT] = _("Crobat"),
    [SPECIES_CHINCHOU] = _("Grainergie"),
    ...
    [SPECIES_PHANPY] = _("Monay"),
    [SPECIES_DONPHAN] = _("Bitgoin"),
    ...
    [SPECIES_TREECKO] = _("Microrge"),
    [SPECIES_GROVYLE] = _("Indrivre"),
    [SPECIES_SCEPTILE] = _("Sceptile"),
    [SPECIES_TORCHIC] = _("Vipuff"),
    [SPECIES_COMBUSKEN] = _("Kaïvaran"),
    [SPECIES_BLAZIKEN] = _("Lacosgator"),
    [SPECIES_MUDKIP] = _("Lubryon"),
    [SPECIES_MARSHTOMP] = _("Tritoris"),
    [SPECIES_SWAMPERT] = _("Vagellaria"),
    [SPECIES_POOCHYENA] = _("Loustiron"),
    [SPECIES_MIGHTYENA] = _("Farcureuil"),
    [SPECIES_ZIGZAGOON] = _("Castoutou"),
    [SPECIES_LINOONE] = _("Pitbrut"),
    [SPECIES_WURMPLE] = _("Larvert"),
    [SPECIES_SILCOON] = _("Araphti"),
    [SPECIES_BEAUTIFLY] = _("Beautifly"),
    [SPECIES_CASCOON] = _("Cuisalide"),
    [SPECIES_DUSTOX] = _("Mosguero"),
    [SPECIES_LOTAD] = _("Rainin"),
    [SPECIES_LOMBRE] = _("Coanobi"),
    [SPECIES_LUDICOLO] = _("Crapumaki"),
    [SPECIES_SEEDOT] = _("Seedot"),
    [SPECIES_NUZLEAF] = _("Nuzleaf"),
    [SPECIES_SHIFTRY] = _("Shiftry"),
    [SPECIES_TAILLOW] = _("Choucaigri"),
    [SPECIES_SWELLOW] = _("Freuneste"),
    [SPECIES_WINGULL] = _("Mouetelot"),
    [SPECIES_PELIPPER] = _("Barbatross"),
    [SPECIES_RALTS] = _("Angrelot"),
    [SPECIES_KIRLIA] = _("Chorillon"),
    [SPECIES_GARDEVOIR] = _("Clepsyphin"),
    [SPECIES_SURSKIT] = _("Navibulle"),
    [SPECIES_MASQUERAIN] = _("Masquerain"),
    [SPECIES_SHROOMISH] = _("Champignom"),
    [SPECIES_BRELOOM] = _("Lutroumpf"),
    [SPECIES_SLAKOTH] = _("Caffuccino"),
    [SPECIES_VIGOROTH] = _("Expresso"),
    [SPECIES_SLAKING] = _("Bistress"),
    [SPECIES_NINCADA] = _("Mollétron"),
    [SPECIES_NINJASK] = _("Limacrotte"),
    [SPECIES_SHEDINJA] = _("Gastropode"),
    [SPECIES_WHISMUR] = _("Mimicule"),
    [SPECIES_LOUDRED] = _("Féloon"),
    [SPECIES_EXPLOUD] = _("Exploud"),
    [SPECIES_MAKUHITA] = _("Hérissohm"),
    [SPECIES_HARIYAMA] = _("Hariyama"),
    [SPECIES_AZURILL] = _("Azurill"),
    [SPECIES_NOSEPASS] = _("Grocaillou"),
    ...
    [SPECIES_MEDITITE] = _("Lièvrette"),
    [SPECIES_MEDICHAM] = _("Fémymate"),
    [SPECIES_ELECTRIKE] = _("Plugynque"),
    [SPECIES_MANECTRIC] = _("Teslotrème"),
    ...
    [SPECIES_GULPIN] = _("Sakafoutre"),
    [SPECIES_SWALOT] = _("Swalot"),
    [SPECIES_CARVANHA] = _("Carvanha"),
    [SPECIES_SHARPEDO] = _("Sharpedo"),
    [SPECIES_WAILMER] = _("Bloufiposi"),
    [SPECIES_WAILORD] = _("Cachalaid"),
    [SPECIES_NUMEL] = _("Inchamel"),
    [SPECIES_CAMERUPT] = _("Camerupt"),
    [SPECIES_TORKOAL] = _("Torkoal"),
    [SPECIES_SPOINK] = _("Bullown"),
    ...
    [SPECIES_LILEEP] = _("Repzilla"),
    [SPECIES_CRADILY] = _("Kaijira"),
    [SPECIES_ANORITH] = _("Kungkong"),
    [SPECIES_ARMALDO] = _("Goruma"),
...
//Hisuian Forms
    ...
    // Mimikyu
    [SPECIES_MIMIKYU_BUSTED] = _("Charton"),
    // Necrozma
