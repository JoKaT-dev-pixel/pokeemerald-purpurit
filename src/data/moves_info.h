...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_KAMEHAMEHA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Concentre son énergie et\n"
            "augmente son Attaque au\n"
            "1er tour. Envoie au 2e\n"
