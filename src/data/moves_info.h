...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SWORDS_DANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Une danse frénétique qui\n"
            "exalte l'esprit combatif.\n"
            "Augmente beaucoup\n"
    ...
    [MOVE_X_SCISSOR] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "utilisant ses faux ou ses\n"
            "griffes comme une paire\n"
            "de ciseaux."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_BUG,
