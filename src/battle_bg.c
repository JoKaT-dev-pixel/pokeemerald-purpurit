...
const struct BattleBackground sBattleTerrainTable[] =
{
    ...
    {
        .tileset = gBattleTerrainTiles_GrassField,
        .tilemap = gBattleTerrainTilemap_GrassField,
        .entryTileset = gBattleTerrainAnimTiles_Building,
        .entryTilemap = gBattleTerrainAnimTilemap_Building,
        .palette = gBattleTerrainPalette_GrassField,
    },
    ...
    [BATTLE_TERRAIN_CITY] =
    {
        .tileset = gBattleTerrainTiles_City,
        .tilemap = gBattleTerrainTilemap_City,
        .entryTileset = gBattleTerrainAnimTiles_Building,
        .entryTilemap = gBattleTerrainAnimTilemap_Building,
        .palette = gBattleTerrainPalette_City,
    },

    [BATTLE_TERRAIN_SEWER] =
    {
        .tileset = gBattleTerrainTiles_Sewer,
        .tilemap = gBattleTerrainTilemap_Sewer,
        .entryTileset = gBattleTerrainAnimTiles_Building,
        .entryTilemap = gBattleTerrainAnimTilemap_Building,
        .palette = gBattleTerrainPalette_Sewer,
    },
    ...
    [BATTLE_TERRAIN_BIRCH_LAB] =
    {
        .tileset = gBattleTerrainTiles_Birch_Lab,
        .tilemap = gBattleTerrainTilemap_Birch_Lab,
        .entryTileset = gBattleTerrainAnimTiles_Building,
        .entryTilemap = gBattleTerrainAnimTilemap_Building,
        .palette = gBattleTerrainPalette_Birch_Lab,
    },
};
    ...
    else
    {
        if (gBattleTypeFlags & BATTLE_TYPE_TRAINER)
        {
            ...
            if (trainerClass == TRAINER_CLASS_LEADER)
            {
                ...
                LoadCompressedPalette(gBattleTerrainPalette_Gym, BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
                return;
            }
