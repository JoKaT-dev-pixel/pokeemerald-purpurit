...
static const u8 sTrainerPicFacilityClass[][GENDER_COUNT] =
{
    ...
    [CARD_TYPE_EMERALD] =
    {
        [MALE]   = FACILITY_CLASS_TRAINER_CARD_M,
        [FEMALE] = FACILITY_CLASS_TRAINER_CARD_F
    }
};
...
static void PrintNameOnCardFront(void)
{
    ...
    if (sData->cardType == CARD_TYPE_FRLG)
        ...
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SHORT, 106, 33, sTrainerCardTextColors, TEXT_SKIP_DRAW, buffer);
}
...
static void PrintIdOnCard(void)
{
    ...
    {
        xPos = GetStringCenterAlignXOffset(FONT_SMALL, buffer, 96) + 120;
        top = 9;
    }

    AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SMALL, xPos, top, sTrainerCardTextColors, TEXT_SKIP_DRAW, buffer);
}
...
static void PrintMoneyOnCard(void)
{
    ...
    if (!sData->isHoenn)
        ...
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SHORT, 106, 57, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardMoney);
    ...
    {
        xOffset = GetStringRightAlignXOffset(FONT_SHORT, gStringVar4, 208);
        top = 57;
    }
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SHORT, xOffset, top, sTrainerCardTextColors, TEXT_SKIP_DRAW, gStringVar4);
}
...
static void PrintPokedexOnCard(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET))
    {
        if (!sData->isHoenn)
            ...
            AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SMALL, 18, 88, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardPokedex);
        ...
        {
            xOffset = GetStringRightAlignXOffset(FONT_SMALL, gStringVar4, 79);
            top = 88;
        }
...
static void PrintTimeOnCard(void)
{
    ...
    if (!sData->isHoenn)
        ...
        AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SHORT, 106, 81, sTrainerCardTextColors, TEXT_SKIP_DRAW, gText_TrainerCardTime);
    ...
    if (minutes > 59)
        minutes = 59;
    width = GetStringWidth(FONT_SHORT, gText_Colon2, 0);
    ...
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SHORT, x, y, sTrainerCardTextColors, TEXT_SKIP_DRAW, gStringVar4);
    x += 18;
    AddTextPrinterParameterized3(WIN_CARD_TEXT, FONT_SHORT, x, y, sTimeColonTextColors[sData->timeColonInvisible], TEXT_SKIP_DRAW, gText_Colon2);
    x += width;
