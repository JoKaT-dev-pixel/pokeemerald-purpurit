...
void SetRivalsName(void)
{
    if (gSaveBlock2Ptr->playerGender == MALE)
        StringCopy(gSaveBlock2Ptr->rivalName, gText_ExpandedPlaceholder_May);
    else
        StringCopy(gSaveBlock2Ptr->rivalName, gText_ExpandedPlaceholder_Brendan);
