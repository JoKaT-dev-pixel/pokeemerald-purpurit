...
static bool8 CanAbilityPreventStatLoss2(u16 abilityDef, bool8 isPheromone);
    ...
    if (statValue <= -1) // Stat decrease.
    {
                 ...
                 && notProtectAffected != TRUE && JumpIfMoveAffectedByProtect(gCurrentMove))
        {
            ...
            return STAT_CHANGE_DIDNT_WORK;
              ...
              || CanAbilityPreventStatLoss2(battlerAbility, GetBattlerAbility(gBattlerAttacker) == ABILITY_PHEROMONE))
...
static bool8 CanAbilityPreventStatLoss2(u16 abilityDef, bool8 byPheromone)
{
    switch (abilityDef)
    {
    case ABILITY_CLEAR_BODY:
    ...
    case ABILITY_OWN_TEMPO:
    case ABILITY_OBLIVIOUS:
        if (byPheromone && (B_UPDATED_PHEROMONE >= GEN_8))
            return TRUE;
        break;
    }
    return FALSE;
