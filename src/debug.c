...
enum GivePCBagFillDebugMenu
{
    ...
    DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_MEDICINES,
...
static void DebugAction_PCBag_Fill_PocketMedicines(u8 taskId);
...
static const u8 sDebugText_PCBag_Fill_PocketMedicines[] =    _("Fill Pocket Medicines");
...
static const struct ListMenuItem sDebugMenu_Items_PCBag_Fill[] =
{
    ...
    [DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_MEDICINES] = {sDebugText_PCBag_Fill_PocketMedicines, DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_MEDICINES},
...
static void (*const sDebugMenu_Actions_PCBag_Fill[])(u8) =
{
    ...
    [DEBUG_PCBAG_MENU_ITEM_FILL_POCKET_MEDICINES] = DebugAction_PCBag_Fill_PocketMedicines,
...
static void DebugAction_PCBag_Fill_PocketMedicines(u8 taskId)
{
    ...
    {
        if (ItemId_GetPocket(itemId) == POCKET_MEDICINES && CheckBagHasSpace(itemId, MAX_BAG_ITEM_CAPACITY))
            AddBagItem(itemId, MAX_BAG_ITEM_CAPACITY);
    }
}
