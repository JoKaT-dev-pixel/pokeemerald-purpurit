...
const u8 gText_ExpandedPlaceholder_Aqua[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}");
const u8 gText_ExpandedPlaceholder_Magma[] = _("{COLOR RED}{SHADOW LIGHT_GRAY}");
const u8 gText_ExpandedPlaceholder_Archie[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("{COLOR DYNAMIC_COLOR4}{SHADOW LIGHT_GRAY}");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("{COLOR LIGHT_RED}{SHADOW RED}");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Dorian");
const u8 gText_ExpandedPlaceholder_May[] = _("Océane");
...
const u8 gText_MainMenuOption[] = _("Paramètres");
...
const u8 gText_ThisIsAPokemon[] = _("Les Pokémon vivent en harmonie avec\nles humains depuis plusieurs années.\pMais vu que vous n'êtes pas des noobs,\nvous connaissez déjà toute l'histoire !{PAUSE 96}\p");
...
const u8 gText_SizeComparedTo[] = _("Taille comparé à ");
...
const u8 gText_SelectorArrow[] = _("{RIGHT_ARROW}");
...
const u8 gText_IDNumber[] = ("NºID");
const u8 gText_BirchInTrouble[] = _("Le Prof. Fildrong a des ennuis !\nChoisis un Pokémon et sauve-le !");
...
const u8 gText_Cancel[] = _("Retour");
...
const u8 gText_CloseBag[] = _("Fermer");
...
const u8 gText_PressAnyDpadKey[] = _("Appuyez sur {DPAD_NONE} pour\nenregistrer dans\nun emplacement.");
...
const u8 gText_MedicinesPocket[] = _("Soins");
...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [BATTLE_ITEMS_POCKET] = gText_BattleItemsPocket,
...
const u8 gText_SoldOut[] = _("Vendu");
const u8 gText_InBagVar1[] = _("Sac: {STR_VAR_1}");
const u8 gText_QuitShopping[] = _("Arrêter d'acheter.");
const u8 gText_Var1CertainlyHowMany[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}{STR_VAR_1} ? Bien sûr !\nCombien vous en voulez ?");
const u8 gText_Var1CertainlyHowMany2[] = _("{STR_VAR_1}? Certainly.\nHow many would you like?");
const u8 gText_Var1AndYouWantedVar2[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Vous voulez prendre {STR_VAR_2} ?\nÇa fera {STR_VAR_3}¥.");
...
const u8 gText_HereYouGoThankYou[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Tenez !\nMerci infiniment.");
...
const u8 gText_AnythingElseICanHelp[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Je peux faire quelque chose d'autre ?");
const u8 gText_CanIHelpWithAnythingElse[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Vous avez besoin d'autre chose ?");
const u8 gText_ThrowInPremierBall[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Je mets une Honor Ball en plus !{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBalls[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Je mets des Honor Balls en plus !{PAUSE_UNTIL_PRESS}");
const u8 gText_CantBuyKeyItem[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}{STR_VAR_2} ? Oh, non.\nJe ne peux pas acheter ça !{PAUSE_UNTIL_PRESS}");
const u8 gText_HowManyToSell[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}{STR_VAR_2} ?\nCombien voulez-vous en vendre ?");
const u8 gText_ICanPayVar1[] = _("{COLOR BLUE}{SHADOW LIGHT_GRAY}Je peux vous en donner {STR_VAR_1}¥.\nÇa vous va ?");
const u8 gText_TurnedOverVar1ForVar2[] = _("Objet vendu pour\n{STR_VAR_1}¥.");
const u8 gText_PokedollarVar1[] = _("{STR_VAR_1}¥");
const u8 gText_Shift[] = _("Échanger");
const u8 gText_SendOut[] = _("Envoyer");
const u8 gText_Switch2[] = _("Déplacer");
const u8 gText_Summary5[] = _("Résumé");
...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 15}2, et{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_M_SPIT_UP}Tadaa !\p{STR_VAR_1} ne sait plus\ncomment utiliser {STR_VAR_2}.\pEt…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MoveToWhere[] = _("Où voulez-vous mettre ce {PKMN} ?");
...
const u8 gText_ChoosePokemonCancel[] = _("Choisir ce {PKMN} ou annuler.");
const u8 gText_ChoosePokemonConfirm[] = _("Choisir ce {PKMN} et confirmer.");
...
const u8 gText_SpDef4[] = _("DÉF. SP.");
...
const u8 gText_PkmnInfo[] = _("INFOS");
const u8 gText_PkmnSkills[] = _("APTITUDES");
const u8 gText_BattleMoves[] = _("CAPACITÉS");
...
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature, met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_Key_Items[] = _("Objets Rares");
...
const u8 gText_MenuOptionPokenav[] = _("PokéPad");
...
const u8 gText_PkmnIsSelected[] = _("{DYNAMIC 0} est sélectionner.");
...
const u8 gText_TrainerCardTime[] = _("Durée Jeu:");
...
const u8 gText_ContinueMenuTime[] = _("Durée de Jeu");
...
const u8 gText_SelectorArrow3[] = _("{RIGHT_ARROW}");
...
const u8 gText_Frame[] = _("Fenêtre");
...
const u8 gText_BattleStyleSet[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Défini");
...
const u8 gText_MenuPokenav[] = _("PokéPad");
...
const u8 gText_DexHoenn[] = _("GAULLIA");
...
const u8 gText_Hoenn[] = _("GAULLIA");
const u8 gText_OhABite[] = _("Oh !\nÇa mord !");
...
const u8 gText_TakeGoodCareOfX[] = _("T'as intérêt à prendre soin de\n{STR_VAR_3} !");
...
const u8 gText_SpAtk[] = _("Atq Spé.");
const u8 gText_SpDef[] = _("Déf Spé.");
...
const u8 gText_Cancel3[] = _("Retour");
...
const u8 gText_Cancel4[] = _("Retour");
...
const u8 gText_Medicines[] = _("Soins");
...
const u8 gText_TMCase_Blue[] =          _("{STR_VAR_2}");

// Exp. Share
const u8 gText_ExpShareOn[] = _("Le Multi Exp est {COLOR GREEN}{SHADOW LIGHT_GREEN}Activé{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("Le Multi Exp est {COLOR RED}{SHADOW LIGHT_RED}Désactivé{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}.{PAUSE_UNTIL_PRESS}");
...
//Items Limit
const u8 gText_ItemLimitHasBeenReached[] = _("Et non :p !\pTu n'avais droit d'utiliser que quatre\nobjets en combat !{PAUSE_UNTIL_PRESS}");