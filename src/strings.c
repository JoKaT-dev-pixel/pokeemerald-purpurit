...
const u8 gText_ThisIsAPokemon[] = _("Les Pokémon vivent en harmonie\navec les humains depuis des années.\pMais ça vous le savez déjà\nsûrement !\p\lle c…{PAUSE 96}\p");
