...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Evan");
...
const u8 gText_ThisIsAPokemon[] = _("Les Pokémon vivent en harmonie avec\nles humains depuis des années.\pMais cette information, vous le savez\ndéjà sûrement !{PAUSE 96}\p");
...
const u8 gText_TrainerCardTime[] = _("Durée de Jeu");
