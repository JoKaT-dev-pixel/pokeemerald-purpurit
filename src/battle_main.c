...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(HIKER, "Bûcheron", 10),
    TRAINER_CLASS(TEAM_AQUA, "Sbire"),
    ...
    TRAINER_CLASS(COLLECTOR, "Geek", 15),
    TRAINER_CLASS(SWIMMER_M, "SWIMMER♂", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "TEAM MAGMA"),
    TRAINER_CLASS(EXPERT, "Coach", 10, ITEM_SPORT_BALL),
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 10),
    TRAINER_CLASS(BLACK_BELT, "Karatéka", 8),
    TRAINER_CLASS(AQUA_LEADER, "AQUA LEADER", 20),
    TRAINER_CLASS(HEX_MANIAC, "Gothique", 6, ITEM_DUSK_BALL),
    TRAINER_CLASS(AROMA_LADY, "Cosplayeuse", 10),
    TRAINER_CLASS(RUIN_MANIAC, "Archéologue", 15),
    TRAINER_CLASS(INTERVIEWER, "Journalistes", 12),
    TRAINER_CLASS(TUBER_F, "Vacanciers", 1),
    TRAINER_CLASS(TUBER_M, "Gay", 8, ITEM_LOVE_BALL),
    TRAINER_CLASS(LADY, "Prostituée", 20),
    TRAINER_CLASS(BEAUTY, "Influenceuse", 20),
    TRAINER_CLASS(RICH_BOY, "Bourgeois", 50, ITEM_PREMIER_BALL),
    TRAINER_CLASS(POKEMANIAC, "Furry", 15, ITEM_FRIEND_BALL),
    TRAINER_CLASS(GUITARIST, "Punk", 8),
    TRAINER_CLASS(KINDLER, "Junkie", 3),
    ...
    TRAINER_CLASS(LEADER, "Champion", 25),
    TRAINER_CLASS(SCHOOL_KID, "Étudiant"),
    TRAINER_CLASS(SR_AND_JR, "Employé", 4),
    TRAINER_CLASS(WINSTRATE, "Cuisinier", 10),
    TRAINER_CLASS(POKEFAN, "POKéFAN", 20),
    TRAINER_CLASS(YOUNGSTER, "Gamin", 4),
    TRAINER_CLASS(CHAMPION, "Maître", 50),
    TRAINER_CLASS(FISHERMAN, "Pêcheur", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_BALL : ITEM_LURE_BALL),
    TRAINER_CLASS(TRIATHLETE, "TRIATHLETE", 10),
    TRAINER_CLASS(DRAGON_TAMER, "Mime", 12),
    TRAINER_CLASS(NINJA_BOY, "SDF", 0, ITEM_RUST_BALL),
    TRAINER_CLASS(BATTLE_GIRL, "Fitgirl", 6),
    TRAINER_CLASS(PARASOL_LADY, "Star du X", 10),
    TRAINER_CLASS(SWIMMER_F, "SWIMMER♀", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TWINS, "Jumelles", 3),
    TRAINER_CLASS(SAILOR, "Marin", 8),
    TRAINER_CLASS(COOLTRAINER_2, "Policier", 5),
    TRAINER_CLASS(MAGMA_ADMIN, "MAGMA ADMIN", 10),
    TRAINER_CLASS(RIVAL, "Rival", 15),
    TRAINER_CLASS(BUG_CATCHER, "Scout", 4),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} RANGER", 12),
    TRAINER_CLASS(MAGMA_LEADER, "MAGMA LEADER", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(LASS, "Fillette", 4),
    TRAINER_CLASS(YOUNG_COUPLE, "YOUNG COUPLE", 8),
    TRAINER_CLASS(OLD_COUPLE, "Voyou", 10, ITEM_BLACK_BALL),
    TRAINER_CLASS(SIS_AND_BRO, "Pickpocket", 20),
    ...
    TRAINER_CLASS(NUN, "Religieuse", 3, ITEM_HEAL_BALL),
    TRAINER_CLASS(PASTOR, "Prêtre", 6),
};
...
const u8* FaintClearSetData(u32 battler)
{
    ...
    gProtectStructs[battler].regalElevated = FALSE;
