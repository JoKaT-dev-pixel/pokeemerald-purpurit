...
{
    [CONTEST_EFFECT_HIGHLY_APPEALING]                      = COMPOUND_STRING("Une démonstration qui\nplaît énormément."),
    ...
    [CONTEST_EFFECT_STARTLE_PREV_MONS]                     = COMPOUND_STRING("Effraie les Pokémon ayant\nfait leur démonstration."),
    [CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON]               = COMPOUND_STRING("Effraie beaucoup le\nPokémon précédent."),
    [CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS]               = COMPOUND_STRING("Effraie beaucoup ceux qui\nont déjà fait leur démo."),
    [CONTEST_EFFECT_STARTLE_PREV_MON_2]                    = COMPOUND_STRING("Startles the POKéMON that\nappealed before the user."),
    [CONTEST_EFFECT_STARTLE_PREV_MONS_2]                   = COMPOUND_STRING("Effraie tous les Pokémon\nayant fait leur démo\navant."),
    [CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION]                 = COMPOUND_STRING("Shifts the JUDGE's\nattention from others."),
    [CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION]     = COMPOUND_STRING("Effraie le Pokémon qui a\nl'attention du Juge."),
    ...
    [CONTEST_EFFECT_APPEAL_AS_GOOD_AS_PREV_ONES]           = COMPOUND_STRING("Rend la démo aussi\nréussie que les\nprécédentes."),
    ...
    [CONTEST_EFFECT_NEXT_APPEAL_EARLIER]                   = COMPOUND_STRING("Prochaine démo exécutée\nplus tôt au tour suivant."),
