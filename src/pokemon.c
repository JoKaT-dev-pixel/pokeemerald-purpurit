...
{
    [NATURE_HARDY] = COMPOUND_STRING("Hardi"),
    [NATURE_LONELY] = COMPOUND_STRING("Solo"),
    [NATURE_BRAVE] = COMPOUND_STRING("Brave"),
    [NATURE_ADAMANT] = COMPOUND_STRING("Rigide"),
    [NATURE_NAUGHTY] = COMPOUND_STRING("Mauvais"),
    [NATURE_BOLD] = COMPOUND_STRING("Assuré"),
    [NATURE_DOCILE] = COMPOUND_STRING("Docile"),
    [NATURE_RELAXED] = COMPOUND_STRING("Relax"),
    [NATURE_IMPISH] = COMPOUND_STRING("Malin"),
    [NATURE_LAX] = COMPOUND_STRING("Lâche"),
    [NATURE_TIMID] = COMPOUND_STRING("Timide"),
    [NATURE_HASTY] = COMPOUND_STRING("Pressé"),
    [NATURE_SERIOUS] = COMPOUND_STRING("Sérieux"),
    [NATURE_JOLLY] = COMPOUND_STRING("Jovial"),
    [NATURE_NAIVE] = COMPOUND_STRING("Naïf"),
    [NATURE_MODEST] = COMPOUND_STRING("Modeste"),
    [NATURE_MILD] = COMPOUND_STRING("Doux"),
    [NATURE_QUIET] = COMPOUND_STRING("Discret"),
    [NATURE_BASHFUL] = COMPOUND_STRING("Pudique"),
    [NATURE_RASH] = COMPOUND_STRING("Foufou"),
    [NATURE_CALM] = COMPOUND_STRING("Calme"),
    [NATURE_GENTLE] = COMPOUND_STRING("Gentil"),
    [NATURE_SASSY] = COMPOUND_STRING("Malpoli"),
    [NATURE_CAREFUL] = COMPOUND_STRING("Prudent"),
    [NATURE_QUIRKY] = COMPOUND_STRING("Bizarre"),
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_TREECKO - 1]       = ANIM_V_JUMPS_BIG,
    [SPECIES_GROVYLE - 1]       = ANIM_V_STRETCH,
    [SPECIES_SCEPTILE - 1]      = ANIM_V_SHAKE,
    [SPECIES_TORCHIC - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
                              ...
                              || (!(effectFlags & (ITEM4_REVIVE >> 2)) && GetMonData(mon, MON_DATA_HP, NULL) == 0))
                        {
                            ...
                            if (gMain.inBattle)
                            {
                                if (battlerId != MAX_BATTLERS_COUNT)
                                {
                                    ...
                                    if (GetBattlerSide(battlerId) == B_SIDE_PLAYER && gBattleResults.numRevivesUsed < 255)
