...
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xA0
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     0xA1
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    0xA2
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   0xA3
//slow running
#define MOVEMENT_ACTION_RUN_DOWN_SLOW                   0xA4
#define MOVEMENT_ACTION_RUN_UP_SLOW                     0xA5
#define MOVEMENT_ACTION_RUN_LEFT_SLOW                   0xA6
#define MOVEMENT_ACTION_RUN_RIGHT_SLOW                  0xA7
