...
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_CHARTI_BERRY        (FLAG_HIDDEN_ITEMS_START + 0x3D)
...
#define FLAG_ITEM_RUSTBORO_CITY_REPEL                               0x411
...
#define FLAG_ITEM_PETALBURG_WOODS_X_DEFENSE                         0x422
