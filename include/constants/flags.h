...
#define FLAG_HIDDEN_ITEM_TROPICAL_PASS_SUPER_POTION          (FLAG_HIDDEN_ITEMS_START + 0x2C)
...
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_RARE_CANDY          (FLAG_HIDDEN_ITEMS_START + 0x3D)
...
#define FLAG_GEN6_EXPSHARE 0x264 // Unused Flag
...
#define FLAG_ITEM_PETALBURG_WOODS_POKE_BALL                         0x41F
