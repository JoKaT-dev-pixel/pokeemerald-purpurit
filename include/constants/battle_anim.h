...
#define ANIM_TAG_GLOWY_ORANGE_ORB           (ANIM_SPRITES_START + 413)
#define ANIM_TAG_GLOWY_YELLOW_ORB           (ANIM_SPRITES_START + 414)
#define ANIM_TAG_MATCHA_GOTCHA_ORB          (ANIM_SPRITES_START + 415)
#define ANIM_TAG_NEW_BUBBLE                 (ANIM_SPRITES_START + 416)
