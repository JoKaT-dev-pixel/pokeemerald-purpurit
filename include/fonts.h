...
extern const u16 gFontSmallBWGlyphs[];
extern const u8 gFontSmallBWGlyphWidths[];
...
extern const u16 gFontSmallMenuLatinGlyphs[];
extern const u8 gFontSmallMenuLatinGlyphWidths[];
